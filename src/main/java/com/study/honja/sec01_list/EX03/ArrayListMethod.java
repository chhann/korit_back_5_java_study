package com.study.honja.sec01_list.EX03;
...
public class ArrayListMethod {
    public static void main(String[] args) {
        ...
        aList1.add(4);
        aList1.add(5);
        System.out.println(aList1.toString()); // =~.print(aList1) [3, 4, 5]
        System.out.println(aList1); // 위에 코드랑 같다
        ...
        aList3.set(1, 5);
        aList3.set(3, 6);
        //aList3.set(4, 6); // java.lang.IndexOutOfBoundsException:
        System.out.println(aList3); // [1, 5, 2, 6]

        //#6. remove(int index)
        aList3. remove(1); // 1번 인덱스를 삭제해라는 뜻
        ...
        //#9. isEmpty()
        System.out.println(aList3.isEmpty()); // ture
